...
public class BFScan {
  ...
  public static void main(String[] args) throws IOException {
    ...
    /*for(int k = 0; k < allQuery.nq; k++) {
    	System.out.print(allQuery.query[k].qno + ":" + allQuery.query[k].TermID.size());
    	for(int t : allQuery.query[k].TermID)
    		System.out.print(" " + t);
    	System.out.println("");
    }
    System.exit(-1);*/
    ...
    for(int i = 0; i < numThread; i++) {
      Thread[i] = new RankerThread("Thread", i*segLen, (i+1)*segLen, data, allQuery.query[j], numTopDoc, i, allScore);
      Thread[i].start();
    }
